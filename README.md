...
[![Build Status](https://travis-ci.com/nf-core/lncpipe.svg?branch=master)](https://travis-ci.com/nf-core/lncpipe)
...
## Credits
nf-core/lncpipe was originally written by Project author name (use a comma to separate multiple names)..
