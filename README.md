...
**nf-core/lncpipe** is a bioinformatics best-practise analysis pipeline for
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/lncpipe -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```

See [usage docs](https://nf-co.re/lncpipe/usage) for all of the available options when running the pipeline.
...
The nf-core/lncpipe pipeline comes with documentation about the pipeline: [usage](https://nf-co.re/lncpipe/usage) and [output](https://nf-co.re/lncpipe/output).
